...
- figures/fig1_severity_vs_timing.png — severity metrics vs timing
- figures/fig2_temporal_vs_timing.png — t_peak/t_recovery/duration
- figures/fig3_trajectories.png — gHn and recalc trajectories per scenario
